                        ...
                        <div className="col-xl-4">
                            ...
                            <div className="card">
                                <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                    ...
                                    <img src="/src/Dashboard/Header/Images/profile-img.jpg" alt="Profile" className="rounded-circle" />
                                            ...
                                            <form>
                                                <div className="row mb-3">
                                                    ...
                                                    <div className="col-md-8 col-lg-9">
                                                        <img src="/src/Dashboard/Header/Images/profile-img.jpg" alt="Profile" />
                                                            <div className="pt-2">
